...
Sample Input: Петров;85;92;78 Сидоров;100;88;94 Иванов;58;72;85 Sample Output: 85.0 94.0 71.666666667 81.0 84.0 85.666666667
'''
...
sum_el2 = 0
sum_el3 = 0
with open('/Users/vitalyskiba/Downloads/dataset_3363_4.txt', 'r') as inf, open('text_out_4.txt', 'w') as result :
    for line in inf:
        line = line.strip().split(';')
        a, b,c = int(line[1]), int(line[2]), int(line[3])
        print((a + b + c) / 3, file=result)
        i += 1
        sum_el1 += a
        sum_el2 += b
        sum_el3 += c
    print((sum_el1 / i), (sum_el2 / i), (sum_el3 / i), file=result)
